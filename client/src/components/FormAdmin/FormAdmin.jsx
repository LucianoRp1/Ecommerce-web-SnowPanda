...
import { getAllProductsId } from "../../Redux/actions/index";
...
function Create() {
  ...
  const productInfoId = useSelector((state) => state.productsID); //! producto individual
  const numberSizes = useSelector((state) => state.allProducts);
  const sizeNumber = numberSizes?.filter((size) => size.numbersizes); //! talle por numero
            ...
            <header>
              ...
              <div className="set">
                <div className="pets-spayed-neutered">
                  ...
                  <div className="radio-container">
                    <input
                      id="pets-name"
                      placeholder={productInfoId.name}
                      name="name"
                      value={input.name}
                      type="text"
              ...
              <div className="set">
                <div className="pets-spayed-neutered">
                  ...
                  <div className="radio-container">
                    <input
                      id="pets-breed"
                      placeholder={productInfoId.model}
                      name="model"
                      value={input.model}
                      type="text"
                      onChange={(e) => handleChange(e)}
                ...
                <div className="pets-spayed-neutered">
                  ...
                  <div className="radio-container">
                    <input
                      id="pets-birthday"
                      placeholder={productInfoId.material}
                      name="material"
              ...
              <div className="set">
                <div className="pets-gender">
                  ...
                  <div className="radio-container">
                    <input
                      id="pets-birthday"
                      placeholder={productInfoId.price}
                      name="price"
                      value={input.price}
                      type="number"
                      onChange={(e) => handleChange(e)}
                ...
                <div className="pets-spayed-neutered">
                  ...
                  <div className="radio-container">
                    <select
                      id="pets-birthday"
                      placeholder={productInfoId.activity}
                      name="activity"
              ...
              <div className="pets-spayed-neutered">
                ...
                <div className="radio-container">
                  <input
                    id="pets-birthday"
                    placeholder={productInfoId.description}
                    name="description"
